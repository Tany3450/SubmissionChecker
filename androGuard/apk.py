...
import sys
from androGuard import zipfile
        ...
        for i in self.zip.namelist():
            if i == "AndroidManifest.xml":
                ...
                if self.xml[i] != None:
                    ...
                    for item in self.xml[i].getElementsByTagName('uses-feature'):
                        self.features.append(str(item.getAttributeNS(NS_ANDROID_URI, "name")))

                    for item in self.xml[i].getElementsByTagName('uses-feature'):
                        self.featuresIsRequired.append(str(item.getAttributeNS(NS_ANDROID_URI, "required")))
                    self.valid_apk = True
